...
# Configuration
app.config['UPLOAD_FOLDER'] = 'tmp_uploads'  # Temporary storage (ephemeral)
...
# Tesseract configuration (works on both Render and local)
...
def extract_receipt_data(image_path):
    try:
        ...
        # Extract total price (largest monetary value)
...
def upload():
    ...
    if file and allowed_file(file.filename):
        ...
        # Clean up file immediately (Render has ephemeral storage)
